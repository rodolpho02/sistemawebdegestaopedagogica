...
<div class="row">
    <div class="col-lg-12">
        <h1><small> </small></h1>
        <ol class="breadcrumb">
    		<li class="active"><i class="fa-solid fa-chalkboard-user"></i> - PÁGINA/CADASTRO DOS PROFESSORES </li>
		</ol>
    </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                   ...
                   for ($i=0; $i < count($res); $i++) { 
                    ...
                    <tr>
                    <td> <a class='teste-foto'><?php echo $nomesocial ?><span class='teste-foto2'><img src="../img/professores/<?php echo $imagem?>" class='teste-foto3' width="100" height="100" alt="<?php echo $nomesocial ?>" /></span></a></td>
                        <td><?php echo  $celular_formatado ?></td>
                        <td><?php echo $email ?></td>                        

                        <td>
                        <a href="index.php?pag=<?php echo $pag ?>&funcao=infor&id=<?php echo $id ?>" class='text-primary mr-1' title='Dados Professores'><i class="fa-solid fa-user"></i></a>
                        <a target="_blank" href="../rel/fichadoprofessor.php?id=<?php echo $id ?>" class="text-secondary mr-1" title="Ficha do Professor"><i class="fa-solid fa-file-signature" style="color: #6495ED;"></i></a>
...
<form id="form" method="POST">  
        ...
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div id="divImgConta">
                        <?php if(@$imagem_2 != ""){ ?>
                                    <img src="../img/professores/<?php echo $imagem_2?>" width="350"
 ...
 <div class="modal fade" id="infor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Dados do Professor</h5>
        <a type="button" class="close" href="index.php?pag=<?php echo $pag ?>">
                <span aria-hidden="true">&times;</span></a>
...
$(document).ready( function() {
    ...
    $('#cep').blur(function(){
            ...
            $.ajax({
                 url : 'professores/consultar_cep.php', /* URL que será chamada */ 
