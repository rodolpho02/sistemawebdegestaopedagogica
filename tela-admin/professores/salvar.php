   ...
   for($i = 0, $x = 10; $i <= 8; $i++, $x--){
	...
	for($i = 0, $x = 11; $i <= 9; $i++, $x--){
		if(str_repeat($i, 11) == $cpf) {
			echo 'CPF do Professor é invalido, números repetidos!';
			exit();
		}
	...
	if($somaA != $cpf[9] || $somaB != $cpf[10]){
		echo 'CPF do Professor é invalido!';
		exit();
	}
...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO professores SET imagem = '$imagem_r', nomesocial = :nomesocial, 
    ...
    $res = $pdo->prepare(" UPDATE professores SET nomesocial = :nomesocial, 
    aniversario = :aniversario, genero = :genero, cargo = :cargo, admissao = :admissao, nomecompleto = :nomecompleto, 
	...
	$res = $pdo->prepare(" UPDATE professores SET imagem = '$imagem_r', nomesocial = :nomesocial, 
	aniversario = :aniversario, genero = :genero, cargo = :cargo, admissao = :admissao, nomecompleto = :nomecompleto, 
	rg = :rg, cpf = :cpf, telefone = :telefone, celular = :celular, email = :email, 
	whatsapp = :whatsapp, cep = :cep, rua = :rua, numero = :numero, complemento = :complemento,
	bairro = :bairro, cidade = :cidade, estado = :estado WHERE id = '$id'");
