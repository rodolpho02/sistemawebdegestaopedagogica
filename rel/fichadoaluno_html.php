...
<div class="content-wrapper">
    ...
    for ($i=0; $i < count($res); $i++) { 
        ...
        $cpf_formatado_aluno = substr_replace($cpf, '.', 3, 0);
        $cpf_formatado_aluno  = substr_replace($cpf_formatado_aluno , '.', 7, 0);
        $cpf_formatado_aluno  = substr_replace($cpf_formatado_aluno , '-', 11, 0);

        $cpf_formatado_responsavel = substr_replace($cpfresponsavel, '.', 3, 0);
        $cpf_formatado_responsavel  = substr_replace($cpf_formatado_responsavel  , '.', 7, 0);
        $cpf_formatado_responsavel  = substr_replace($cpf_formatado_responsavel  , '-', 11, 0);

        $aniversario = $res[$i]['aniversario'];
        $aniversario_formatado = date('d/m/Y', strtotime($aniversario));

        $query_r = $pdo->query("SELECT * FROM responsaveis where cpf = '$cpfresponsavel'");
    ...
    <div class="ficha-aluno">
        <div class="conteiner-principal">
            ...
            <div class="foto" >
                <?php if ($imagem) { ?>
                    <img src="../img/alunos/<?php echo $imagem;?>" alt="Foto do Aluno">
                <?php } ?>
                </div>
            </div>
            <div class="conteiner">
        ...
        <table>
            ...
            <tr>
                <td colspan="2">Nome: <?php echo $nomecompleto; ?></td>
            </tr>
            ...
            <tr>
                <td>CPF: <?php echo $cpf_formatado_aluno; ?></td>
                <td>RG: <?php echo $rg_formatado; ?></td>
            </tr>
            <tr>
                <td colspan="2">Certidão de Nascimento: <?php echo $certidaonasc; ?></td>
            </tr>

            <tr>
                <?php if ($cpfresponsavel != '') { ?>
                    <td>Responsável: <?php echo  $nomeresponsavel_r; ?></td>
                    <td>CPF: <?php echo $cpf_formatado_responsavel; ?></td>
                <?php } ?>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="2">Informações Escolares</th>
            </tr>
            <tr>
                <td>Escola: <?php echo $escola; ?></td>
                <td>Turma Escolar: <?php echo $turmaescolar; ?></td>
            </tr>  
            <tr>
                <td>Nível Escolar: <?php echo $nivelescolar; ?></td>
                <td>Ano Escolar: <?php echo $anoescolar; ?></td>
            </tr>
        </table>
    </div>
