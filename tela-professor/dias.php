                ...
                <tbody>
                   ...
                   for ($i=0; $i < count($res); $i++) { 
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="index.php?pag=<?php echo $pag ?>&funcao=gerargrade&id=<?php echo $id ?>" class='text-success mr-1' title='Visualizar Grade de Horário'><i class='fa-solid fa-calendar-days'></i></a>
                        <a target="_blank" href="../rel/quadrodehorario.php?id=<?php echo $id ?>" class="text-secondary mr-1" title="Imprimir Quadro de Horário">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class = "text-danger"> Ao excluir 'DIAS' cadastrado no Sistema, 
                sua Grande de Horário também será excluída e 
                isso poderá incluêciar nas turmas visualizadas pelos Professoras.</p>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form id="form2" method="POST">
                ...
                <?php
                    ...
                    <label >Turmas Disponiveis</label>
                        ...
                        <option <?php if(@$turma_2 == $turma_id){ ?> selected <?php } ?> 
                    ...
                    <label >Primeiro tempo</label>
                        ...
                        <option <?php if(@$materia_1 == $materia_reg_1){ ?> selected <?php } ?> 
                    ...
                    <label >Segundo tempo</label>
                        ...
                        <option <?php if(@$materia_2 == $materia_reg_2){ ?> selected <?php } ?> 
                    ...
                    <label >Quarto tempo</label>
                        ...
                        <option <?php if(@$materia_3 == $materia_reg_3){ ?> selected <?php } ?> 
                    ...
                    <label >Quarto tempo</label>
                        ...
                        <option <?php if(@$materia_4 == $materia_reg_4){ ?> selected <?php } ?> 
           ...
           <div class="modal-footer">
                ...
                <input value="<?php echo @$_GET['id_turma'] ?>" type="hidden" name="txtid4" id="txtid4">
                <input value="<?php echo @$turma_reg?>" type="hidden" name="antigo" id="antigo">
    ...
    <div class="modal-dialog" role="document2">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p class = "text-danger">  
                Ao excluir tempos de aula em sua Grade de Horário 
                isso poderá incluêciar nas turmas visualizadas pelos Professoras.</p>
